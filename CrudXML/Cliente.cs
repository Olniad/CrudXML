...
namespace CrudXML
{
    ...
    public class Clientes
    {
        ...
        public void Salvar()
        {
            ...
            FileStream fs = new FileStream("H://segundotrimestre//Clientes.xml", FileMode.OpenOrCreate);
        ...
        {
            XmlSerializer ser = new XmlSerializer(typeof(List<Cliente>));
            FileStream fs = new FileStream("H://www//POO/SegundaEtapa/CrudXML"), FIleMode.OpenOrCreate);
            try
            {
